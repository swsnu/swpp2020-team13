        ...
        return (
            ...
            <List.Item>
                    <Button.Group className="DeleteTaskButtonGroupAnother" floated="right">
                        <Button compact icon className="DeleteTaskButtonA" id="DeleteButtonTaskBody" onClick={this.onClickDeleteTaskHandler}><Icon name='delete'/>&nbsp;Delete</Button>
                        <Button icon className="EditTaskButtonA" id="EditButtonTaskBody" onClick={()=>this.onClickEditTaskHandler()}><Icon name='edit'/>&nbsp;Edit</Button>
                    </Button.Group> 
            </List.Item>
            <br></br>
        </Segment>
